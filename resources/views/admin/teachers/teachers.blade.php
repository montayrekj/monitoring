    ...
    <body style="background: #eee;">
        ...
        <div class="container-fluid" style="background:#F5FCFF; height: 100%; padding: 0px;">
            ...
            <div class="content" style="width: 80%; height: 100%; float: right; padding: 20px; display: flex; flex-direction: column; overflow: scroll">
                <a href="/admin/teachers/add"><button class="btn btn-success">Add Teacher</button></a>
                <br>
                <div>
                    <table class="table table-striped" id="teachersTable">
                        ...
                        <tbody>
                            @for($counter = 0; $counter < $teachers->count(); $counter++)
                                <tr>
                                    <td>{{$teachers[$counter]->id}}</td>
                                    <td>{{$teachers[$counter]->name}}</td>
                                    <td>
                                        <a href="/admin/teachers/update/{{$teachers[$counter]->id}}"><button class="btn btn-primary">Update</button></a>
                                        <a href="/admin/teachers/delete/{{$teachers[$counter]->id}}"><button class="btn btn-danger">Delete</button></a>
                                    </td>
                                </tr>
                            @endfor
                        </tbody>
